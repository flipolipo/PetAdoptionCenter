...
namespace SimpleWebDal.Migrations
{
    ...
    public partial class addRoles : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
<<<<<<<< HEAD:SimpleWebDal/Migrations/20230929203835_addRoles.cs
                name: "UserPets",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
========
>>>>>>>> Repository:SimpleWebDal/Migrations/20230929123953_firstMigration.cs
                name: "Pets",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserPetsJoinTable_Users_UsersId",
                        column: x => x.UsersId,
